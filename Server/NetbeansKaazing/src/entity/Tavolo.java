...
public class Tavolo implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.posti, other.posti)) {
            return false;
        }
        if (!Objects.equals(this.libero, other.libero)) {
            return false;
        }
        if (!Objects.equals(this.vuolePagare, other.vuolePagare)) {
            return false;
        }
