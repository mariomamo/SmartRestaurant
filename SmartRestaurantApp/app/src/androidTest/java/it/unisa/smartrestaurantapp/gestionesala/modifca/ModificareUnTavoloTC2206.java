...
public class ModificareUnTavoloTC2206 {
    ...
    public void useAppContext() throws InterruptedException {
        ...
        Espresso.onView(withId(R.id.nome)).perform(replaceText("Crystaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaal"));
