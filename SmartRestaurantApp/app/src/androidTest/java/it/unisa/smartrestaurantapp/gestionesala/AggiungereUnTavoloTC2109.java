...
public class AggiungereUnTavoloTC2109 {
    ...
    public void useAppContext() throws InterruptedException {
        ...
        Espresso.onView(withId(R.id.password)).perform(typeText("pass"));
        Espresso.onView(withId(R.id.nome)).perform(typeText("Crystaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaal"));
