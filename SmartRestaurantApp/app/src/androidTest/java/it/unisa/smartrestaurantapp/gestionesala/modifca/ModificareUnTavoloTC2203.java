...
public class ModificareUnTavoloTC2203 {
    ...
    public void useAppContext() throws InterruptedException {
        ...
        //Inserisco i dati
        Espresso.onView(withId(R.id.password)).perform(replaceText("passwoooooooooooooooooooooooooooooooooooooooord1234"));
        Espresso.onView(withId(R.id.nome)).perform(replaceText("Crystal"));
        ...
        Espresso.onView(withText("Password non rispetta il formato")).inRoot(new ToastMatcher()).check(matches(isDisplayed()));
    }
}
