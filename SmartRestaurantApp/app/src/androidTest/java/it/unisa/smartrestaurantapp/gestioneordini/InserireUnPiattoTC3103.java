...
public class InserireUnPiattoTC3103 {
    @Rule
    ...
    public void useAppContext() throws InterruptedException {
        ...
        Espresso.onView(withId(R.id.et_allergie)).perform(replaceText("Senza latteeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"));
        Espresso.onView(withId(R.id.btn_aggiungi)).perform(click());
        Espresso.onView(withText("Lunghezza massima per le note: 255")).inRoot(new ToastMatcher()).check(matches(isDisplayed()));
        Thread.sleep(1500);
    }
}
