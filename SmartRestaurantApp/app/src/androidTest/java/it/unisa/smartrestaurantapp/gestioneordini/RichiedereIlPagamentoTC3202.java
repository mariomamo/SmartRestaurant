...
public class RichiedereIlPagamentoTC3202 {
    @Rule
    ...
    public void useAppContext() throws InterruptedException {
        ...
        Espresso.onView(withId(R.id.review)).perform(replaceText("Troppo caroooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo"));
        Espresso.onView(withId(R.id.conferma)).perform(click());
        Espresso.onView(withText("La recensione non deve superare i 255 caratteri")).inRoot(new ToastMatcher()).check(matches(isDisplayed()));
        Thread.sleep(1500);
    }
}
