...
public class ModificareUnTavoloTC2208 {
    ...
    public void useAppContext() throws InterruptedException {
        ...
        Espresso.onView(withId(R.id.posti)).perform(replaceText("1000"));
        ...
        Espresso.onView(withText("Posti non rispetta il formato")).inRoot(new ToastMatcher()).check(matches(isDisplayed()));
    }
}
