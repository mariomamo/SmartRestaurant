...
public class AggiungereUnTavoloTC2110 {
    ...
    public void useAppContext() throws InterruptedException {
        ...
        Espresso.onView(withId(R.id.password)).perform(typeText("pass"));
        Espresso.onView(withId(R.id.nome)).perform(typeText("Crystal table"));
        Espresso.onView(withId(R.id.posti)).perform(typeText("0"));
